...
public class Message implements Serializable {
    ...
    /**
     * Slack user ID (legacy, platform-specific)
     */
    private String slackUserId;

    /**
     * Unique user ID (unified identifier across platforms)
     * Preferred over slackUserId for lookups and processing
     */
    @Indexed
    ...
    /**
     * User's avatar URL (unified, platform-agnostic)
     * Preferred over imageOriginal for avatar display
     */
    private String avatarUrl;

    /**
     * User's original image URL (legacy)
     */
    ...
    /**
     * Source platform of the message (e.g., slack, email, etc.)
     */
